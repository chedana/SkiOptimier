...
- **实时价格搜索** — Bot 自动用 browser 工具打开 Google Flights/Trainline/FlixBus 抓取真实航班价格、时刻、行李信息
- **价格搜索 CLI** — `ski-run.sh price-search` 为每段行程生成搜索查询和 URL，Bot 逐段搜索展示
- **用户偏好筛选** — 4 种偏好模式（便宜/时间/舒适/平衡），按偏好排序航班推荐
